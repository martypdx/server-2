...
// router.post('/me/accounts', (request, response, next) => {
...
//       return user.save();
//     })
//     .then(user => response.send(user.accounts))
//     .catch(next);
// });
...
//   //TODO: Determin how to set the access token to the user and transition to the next screen
